...
function fizzBuzz(num) {
   ...
   // Tu código:
   if ( num % 3 === 0 && num % 5 === 0 && num % 1 === 0) return ("fizzbuzz");
   if ( num % 3 === 0 && num % 1 === 0) return ("fizz");
   if ( num % 5 === 0 && num % 1 === 0) return ("buzz");  
   return (num);
}
...
function operadoresLogicos(num1, num2, num3) {
   ...
   // Tu código:
   if ( num1 > num2 && num1 > num3 && num1 % 1 === 0) return ("Numero 1 es mayor y positivo")
...
function esVerdadero(valor) {
   ...
   if (valor != true) return ("Soy falso");
}
